...
CREATE VIEW gabinete-sv.br_tse_eleicoes.receita_candidatos AS
SELECT 
...
SAFE_CAST(count AS INT64) count,
SAFE_CAST(receita_voto AS FLOAT64) receita_voto,
SAFE_CAST(ano AS INT64) ano,
SAFE_CAST(sigla_uf AS STRING) sigla_uf
from gabinete-sv.br_tse_eleicoes_staging.receita_candidatos as t
